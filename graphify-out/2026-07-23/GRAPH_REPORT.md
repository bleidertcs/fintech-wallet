# Graph Report - fintech-wallet  (2026-07-23)

## Corpus Check
- 213 files · ~111,871 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1798 nodes · 2473 edges · 145 communities (125 shown, 20 thin omitted)
...
- `UserServiceTest` --references--> `UserService`  [EXTRACTED]
  .agents/skills/spring-boot-full-stack/src/test/java/com/company/app/service/UserServiceTest.java → .agents/skills/spring-boot-full-stack/src/main/java/com/company/app/service/UserService.java
...
Cohesion: 0.24
Nodes (10): Create, Delete, FindAll, FindById, DisplayName, Nested, Test, Update (+2 more)
...
Cohesion: 0.29
Nodes (6): RequiredArgsConstructor, Service, Slf4j, Transactional, UserServiceBlockingStub, TransactionService
...
Cohesion: 0.15
Nodes (11): AllArgsConstructor, Builder, Data, Entity, NoArgsConstructor, PrePersist, Table, MoneyRequest (+3 more)
...
Cohesion: 0.15
Nodes (13): GetMapping, PutMapping, RequestMapping, RequiredArgsConstructor, ResponseEntity, RestController, TransactionController, AllArgsConstructor (+5 more)
...
## Knowledge Gaps
- **676 isolated node(s):** `com.company:spring-boot-app`, `start-local.sh script`, `api-gateway:api-gateway`, `auth-service:auth-service`, `notification-service:notification-service` (+671 more)
...
- **Why does `UserRepository` connect `User` to `MoneyRequest`, `AuthService`, `StatementService`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `NotificationRepository` connect `NotificationService` to `MoneyRequest`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `TransactionService` connect `TransactionService` to `MoneyRequest`, `TransactionController`, `.transfer`, `IdempotencyService`, `TransferCompletedEvent`?**
