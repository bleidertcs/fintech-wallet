# Graph Report - fintech-wallet  (2026-07-27)

## Corpus Check
- 224 files · ~119,395 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1960 nodes · 2642 edges · 154 communities (133 shown, 21 thin omitted)
...
Cohesion: 0.04
Nodes (47): 4. Acceder a los servicios, 5. Crear tu primer usuario, API Gateway (Puerto 8080), Arquitectura, Auth Service (Puerto 8081), Avanzadas, Backend, Base de Datos (+39 more)
...
### Community 134 - "Development Workflow"
Cohesion: 0.14
Nodes (13): 🎯 1. Objetivos del Despliegue en Docker Swarm, 🏗️ 2. Arquitectura de Redes y Servicios en Swarm, 🛠️ 3. Estructura del Proyecto para Docker Swarm, 4.1 Inicialización del Clúster (Si no está activo), 4.2 Despliegue del Stack, 4.3 Verificación de Servicios, 4.4 Escalado Dinámico de Microservicios, 4.5 Despliegue de Nuevas Versiones sin Caídas (Rolling Update) (+5 more)
...
### Community 156 - "StatementService"
Cohesion: 0.39
Nodes (6): Async, StatementJobRepository, RequiredArgsConstructor, Service, Slf4j, StatementService
...
## Knowledge Gaps
- **777 isolated node(s):** `swarm-init.sh script`, `com.company:spring-boot-app`, `start-local.sh script`, `api-gateway:api-gateway`, `auth-service:auth-service` (+772 more)
