# Graph Report - fintech-wallet  (2026-09-01)

## Corpus Check
- 520 files · ~278,607 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5041 nodes · 6155 edges · 628 communities (352 shown, 276 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `40d98d6f`
...
## Communities (628 total, 276 thin omitted)
...
Cohesion: 0.13
Nodes (14): 1. Visión General de la Arquitectura de Capas, 2. Los Desafíos Técnicos Identificados, 3. La Solución Implementada: Flujo de 4 Pasos, 4. Matriz de Endpoints y Puertos Activos, 5. Guía Operativa: ¿Qué hacer si reinicio el sistema o Podman?, A. La Trampa del Loopback (`127.0.0.1`) en WSL2, Arquitectura de Red y Conectividad: Kubernetes (Kind) sobre Podman en Windows (WSL2), B. Filtrado de Paquetes en el Firewall Netavark (+6 more)

### Community 122 - "auth-service:auth-service"
Cohesion: 0.22
Nodes (9): dependencies, kafkajs, @opentelemetry/resources, reflect-metadata, rxjs, kafkajs, @opentelemetry/resources, reflect-metadata (+1 more)
...
Cohesion: 0.22
Nodes (9): dependencies, nest-winston, @nestjs/config, rxjs, winston, nest-winston, @nestjs/config, rxjs (+1 more)
...
## Knowledge Gaps
- **2563 isolated node(s):** `com.company:spring-boot-app`, `start-local.sh script`, `$schema`, `collection`, `sourceRoot` (+2558 more)
...
- **Why does `dependencies` connect `dependencies` to `@opentelemetry/sdk-metrics`, `rxjs`, `package.json`, `@opentelemetry/instrumentation-express`, `@nestjs/core`, `qrcode.react`, `eslint`, `@opentelemetry/sdk-trace-web`, `recharts`, `react-dom`, `class-transformer`, `@opentelemetry/instrumentation-express`, `@opentelemetry/instrumentation-nestjs-core`?**
