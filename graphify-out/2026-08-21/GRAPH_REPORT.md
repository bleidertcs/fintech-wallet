# Graph Report - fintech-wallet  (2026-08-21)

## Corpus Check
- 504 files · ~257,797 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4984 nodes · 6085 edges · 646 communities (345 shown, 301 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `33cc726b`
...
## Communities (646 total, 301 thin omitted)
...
Cohesion: 0.16
Nodes (7): RedisModule, Module, RedisTokenBlacklistAdapter, Inject, Injectable, CACHE_SERVICE_PORT, CacheServicePort
...
Cohesion: 0.13
Nodes (13): Inject, Injectable, UserTrpcRouter, AppModule, Module, createWinstonLogger(), otelLogFormat, logger (+5 more)
...
Cohesion: 0.06
Nodes (41): AuthController, ApiOperation, ApiTags, Body, Controller, Get, HttpCode, Inject (+33 more)
...
Cohesion: 0.07
Nodes (21): GlobalExceptionFilter, AppModule, Module, AuthModule, Module, Environment, EnvironmentVariables, IsNumber (+13 more)

### Community 44 - "TransferCompletedEvent"
Cohesion: 0.25
Nodes (8): 1. **Start High-Level, Then Zoom In**, 2. **Use Framework Examples as Templates**, 3. **Include Technology Stack**, 4. **Validate Diagram Syntax**, 5. **Keep Diagrams Current**, 6. **Use Semantic Unicode Symbols**, 7. **Document Diagram Scope**, Best Practices
...
Cohesion: 0.22
Nodes (9): dependencies, bcrypt, jsonwebtoken, @nestjs/terminus, @opentelemetry/exporter-logs-otlp-http, @nestjs/terminus, bcrypt, jsonwebtoken (+1 more)
...
### Community 59 - "mvnw"
Cohesion: 0.12
Nodes (16): Analysis Workflow, Code-to-Diagram Master Guide, Decision Tree, Diagram Type Mapping, Overview, Quick Reference Table, Quick Start Checklist, Step 1: Identify Framework and Patterns (+8 more)
...
Cohesion: 0.16
Nodes (6): NodemailerEmailAdapter, Injectable, EMAIL_SERVICE_PORT, EmailServicePort, USER_PROFILE_CLIENT_PORT, USER_REPOSITORY_PORT
...
Cohesion: 0.29
Nodes (7): Express.js → Diagrams, FastAPI → Diagrams, Framework-Specific Guides, Java Servlet → Diagrams, Python ETL → Diagrams, React → Diagrams, Spring Boot → Diagrams
...
Cohesion: 0.33
Nodes (6): 1. Layered Architecture (MVC), 2. Microservices, 3. Event-Driven, 4. CQRS (Command Query Responsibility Segregation), Common Architectural Patterns, Pattern Recognition
...
Cohesion: 0.33
Nodes (6): Common Pitfalls, ❌ Pitfall 1: Mixing Abstraction Levels, ❌ Pitfall 2: Overloading Diagrams, ❌ Pitfall 3: Missing Communication Protocols, ❌ Pitfall 4: Ignoring Error Paths, ❌ Pitfall 5: Outdated Diagrams
...
Cohesion: 0.10
Nodes (21): devDependencies, eslint, eslint-config-prettier, @eslint/eslintrc, globals, @nestjs/schematics, prisma, supertest (+13 more)
...
Cohesion: 0.29
Nodes (7): 5.1. Propósito, 5.2. Responsabilidades, 5.3. Arquitectura Interna, 5.4. Canales de Entrada y Salida, 5.5. Variables de Configuración, 5.6. Puertos, Rutas y Health Checks, 5. Worker Service (`worker-service`)
...
Cohesion: 0.15
Nodes (14): UpdateBalanceRequest, UserRequest, ApiPropertyOptional, IsNumber, IsOptional, UpdateBalanceDto, AppRouter, t (+6 more)
...
Cohesion: 0.16
Nodes (9): Inject, Inject, Injectable, UserProfileHttpClient, Inject, Injectable, UserProfileTrpcClient, UserProfileClientPort (+1 more)
...
Cohesion: 0.08
Nodes (24): 1. Keep Flows Focused, 2. Use Clear Naming, 3. Consistent Decision Logic, 4. Handle Error Paths, 5. Use Subgraphs for Organization, Activity Diagram Guide, Activity Diagram Templates, Anti-Patterns to Avoid (+16 more)
...
Cohesion: 0.22
Nodes (9): dependencies, kafkajs, @opentelemetry/exporter-metrics-otlp-http, @opentelemetry/semantic-conventions, @trpc/client, kafkajs, @opentelemetry/exporter-metrics-otlp-http, @opentelemetry/semantic-conventions (+1 more)
...
Cohesion: 0.22
Nodes (9): dependencies, class-transformer, @nestjs/swagger, @nestjs/terminus, rxjs, class-transformer, @nestjs/swagger, @nestjs/terminus (+1 more)
...
### Community 398 - "@opentelemetry/exporter-metrics-otlp-http"
Cohesion: 0.33
...
### Community 417 - "axios"
Cohesion: 0.50
Nodes (4): Authentication Flow, Common Patterns, Data Processing Pipeline, E-commerce Checkout Flow
...
Cohesion: 0.12
Nodes (16): 1. Arquitectura del Clúster y Namespace `fintech`, 1. Inspección de Recursos, 2. Estructura y Orden de los Manifiestos (`k8s/`), 2. Inspección de Logs en Tiempo Real, 3. Ejecución de Comandos dentro de Pods, 3. Matriz Exhaustiva de Componentes Kubernetes, 4. Estrategia de Recursos y Scheduler QoS, 4. Reinicio Controlado (Rolling Restart) (+8 more)
...
## Knowledge Gaps
- **2531 isolated node(s):** `com.company:spring-boot-app`, `start-local.sh script`, `$schema`, `collection`, `sourceRoot` (+2526 more)
...
- **Why does `User` connect `Docker Swarm Skill` to `PrismaService`, `App.jsx`, `eslint-plugin-prettier`, `.findByEmail`, `user.entity.ts`, `AuthController`, `TransactionServiceApplicationTests.java`?**
