...
## Corpus Check
- 514 files · ~273,642 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5019 nodes · 6139 edges · 621 communities (347 shown, 274 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 16 edges (avg confidence: 0.78)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `25743ac6`
...
Cohesion: 0.10
Nodes (21): file-saver, dependencies, file-saver, html5-qrcode, jspdf, jspdf-autotable, @opentelemetry/exporter-trace-otlp-http, @opentelemetry/instrumentation (+13 more)
...
Cohesion: 0.10
Nodes (21): devDependencies, eslint-config-prettier, eslint-plugin-prettier, @nestjs/cli, prettier, supertest, ts-jest, ts-node (+13 more)
...
Cohesion: 0.12
Nodes (17): Activation Boxes, Authentication Flows, Basic Elements, Error Handling, Message Types, Microservices Communication, Participants, Pattern - Circuit Breaker (+9 more)
...
Cohesion: 0.83
Nodes (3): exec_cmd(), get_ssh_client(), main()
...
Cohesion: 0.09
Nodes (23): devDependencies, eslint-plugin-prettier, globals, jest, @nestjs/cli, @nestjs/schematics, prettier, source-map-support (+15 more)
...
Cohesion: 0.07
Nodes (29): dependencies, class-transformer, nest-winston, @nestjs/common, @nestjs/microservices, @nestjs/platform-express, @nestjs/swagger, @opentelemetry/exporter-logs-otlp-http (+21 more)
...
## Knowledge Gaps
- **2551 isolated node(s):** `com.company:spring-boot-app`, `start-local.sh script`, `$schema`, `collection`, `sourceRoot` (+2546 more)
...
- **Why does `dependencies` connect `dependencies` to `@opentelemetry/sdk-metrics`, `rxjs`, `package.json`, `@opentelemetry/instrumentation-express`, `qrcode.react`, `@nestjs/common`, `axios`, `eslint`, `@opentelemetry/sdk-trace-web`, `recharts`, `class-transformer`, `@opentelemetry/instrumentation-express`, `@opentelemetry/instrumentation-nestjs-core`?**
...
- **What connects `com.company:spring-boot-app`, `start-local.sh script`, `$schema` to the rest of the system?**
  _2551 weakly-connected nodes found - possible documentation gaps or missing edges._
