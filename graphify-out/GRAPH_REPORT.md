...
## Corpus Check
- 460 files · ~192,073 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3877 nodes · 4908 edges · 560 communities (253 shown, 307 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 20 edges (avg confidence: 0.72)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `03f589c5`
...
## Communities (560 total, 307 thin omitted)
...
Cohesion: 0.18
Nodes (11): devDependencies, supertest, ts-jest, ts-loader, @types/express, @types/jest, supertest, ts-jest (+3 more)
...
Cohesion: 0.12
Nodes (16): Overview, Requirement: Error Response, Requirement: Global Exception Handler, Requirement: HTTP Status Codes, Requirement: Pagination, Requirement: Request Validation, Requirement: Response Wrapper, Requirement: URL Conventions (+8 more)
...
Cohesion: 0.14
Nodes (6): EventEnvelope, TransferCompletedEventPayload, PrismaService, Injectable, IdempotencyService, Injectable
...
Cohesion: 0.09
Nodes (11): PrismaTransactionRepository, Injectable, TransactionUseCases, Injectable, MoneyRequestEntity, TransactionEntity, MoneyRequestParams, TransactionServicePort (+3 more)
...
Cohesion: 0.22
Nodes (9): dependencies, ioredis, @nestjs/microservices, @opentelemetry/exporter-metrics-otlp-http, rxjs, ioredis, @nestjs/microservices, @opentelemetry/exporter-metrics-otlp-http (+1 more)
...
Cohesion: 0.11
Nodes (6): TransferMoneyCommandHandler, Inject, TransferCompletedEvent, Money, UserId, CommandHandler
...
## Knowledge Gaps
- **1790 isolated node(s):** `com.company:spring-boot-app`, `start-local.sh script`, `$schema`, `collection`, `sourceRoot` (+1785 more)
