...
## Corpus Check
- 516 files · ~275,493 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 5021 nodes · 6138 edges · 623 communities (346 shown, 277 thin omitted)
...
## Communities (623 total, 277 thin omitted)
...
Cohesion: 0.14
Nodes (7): RedisModule, Module, RedisTokenBlacklistAdapter, Injectable, CACHE_SERVICE_PORT, CacheServicePort, USER_PROFILE_CLIENT_PORT
...
Cohesion: 0.19
Nodes (6): NodemailerEmailAdapter, Injectable, UserProps, EMAIL_SERVICE_PORT, EmailServicePort, USER_REPOSITORY_PORT
...
Cohesion: 0.14
Nodes (9): JwtAuthGuard, Inject, Injectable, TOKEN_SERVICE_PORT, TokenPayload, TokenServicePort, JwtUtil, Inject (+1 more)
...
Cohesion: 0.10
Nodes (21): Activation Boxes, Advanced Patterns, Authentication Flows, Basic Elements, Error Handling, Message Types, Microservices Communication, Participants (+13 more)
...
Cohesion: 0.09
Nodes (19): AppModule, Module, AuthModule, Module, Environment, EnvironmentVariables, IsNumber, IsOptional (+11 more)

### Community 122 - "auth-service:auth-service"
Cohesion: 0.22
Nodes (9): dependencies, class-validator, @opentelemetry/resources, reflect-metadata, rxjs, class-validator, @opentelemetry/resources, reflect-metadata (+1 more)
...
Cohesion: 0.50
Nodes (4): Async Messaging Patterns, Pattern - Dead Letter Queue Handling, Pattern - Event-Driven with Message Queue, Pattern - Saga with Compensating Transactions
...
Cohesion: 0.14
Nodes (10): Inject, Inject, Injectable, UserProfileHttpClient, Inject, Inject, Injectable, UserProfileTrpcClient (+2 more)
...
Cohesion: 0.10
Nodes (21): dependencies, class-transformer, class-validator, kafkajs, @nestjs/config, @nestjs/microservices, @opentelemetry/exporter-logs-otlp-http, @opentelemetry/resources (+13 more)
...
Cohesion: 0.09
Nodes (8): qrcode, AuthUseCases, Inject, Injectable, AuthResult, TotpSetupResult, TotpUtil, qrcode
...
- **Why does `User` connect `Docker Swarm Skill` to `PrismaService`, `App.jsx`, `eslint-plugin-prettier`, `.findByEmail`, `dashboard-config.js`, `user.entity.ts`, `AuthController`?**
